...
<html>
<head>
<title> Sign Up Form Responsive Widget Template| Home :: W3layouts</title>
<!-- Meta tag Keywords -->
	...
	<h2 class="sub-head">Sign Up</h2>
		<div class="sub-main">	
			<form action="../register" method="post">
				<input placeholder="First Name" name="uname"  type="text" required="">
					<span class="icon1"><i class="fa fa-user" aria-hidden="true"></i></span><br>
				<input placeholder="Last Name" name="uname"  type="text" required="">
				...
				<input placeholder="Email" name="email" type="text" required="">
					...
					<input placeholder="Phone Number" name="mobile"  type="text" required="">
