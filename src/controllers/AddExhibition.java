...
public class AddExhibition extends HttpServlet {
    ...
    //String query = "select * from gallery where g_name='" + g_name + "' ";
     ...
     // rs.beforeFirst();
      ...
      PreparedStatement pst =(PreparedStatement) conn.prepareStatement("insert into exhibition (e_id,e_name, e_type, start_date, end_date,venue) values(?,?,?,?,?,?)");//try2 is the name of the table  
